...
class AecpCommandSlider : public QSlider
{
public:
	...
	static_assert(std::is_integral_v<DataType> && sizeof(DataType) <= 4, "AecpCommandSlider only support integral types up to 32 bits");

	AecpCommandSlider(QWidget* parent = nullptr)
		: QSlider{ Qt::Horizontal, parent }
		, _parent{ parent }
	{
		// Send changes
		connect(this, QOverload<int>::of(&QSlider::valueChanged), this,
			[this](int value)
			{
